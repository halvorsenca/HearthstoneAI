...
def test_full_game():
	...
	cards2 = db.decks.find({"DeckName":"Hunter Aggro"},{"Cards":1,"_id":0})
...
# If we ran with only one thread then don't bother merging
# the only time this happens is when seeing how often it wins
	if numThreads != 1:
